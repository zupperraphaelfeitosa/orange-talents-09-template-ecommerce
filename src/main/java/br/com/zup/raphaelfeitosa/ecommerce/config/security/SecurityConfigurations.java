...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/produtos/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/usuarios").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/autenticacao").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/pagamentos/**").permitAll()
                .antMatchers(HttpMethod.POST, "/servico-nota-fiscal/**").permitAll()
                .antMatchers(HttpMethod.POST, "/servico-ranking-vendedores/**").permitAll()
